...
object Execute extends Extract {
  ...
  val allValueNames = Seq(
    "plan", "skipAll", "stopOnFail", "stopOnError", "stopOnIssue", "stopOnSkip", "sequential", "asap", "isolated",
    "threadsNb", "scheduledThreadsNb", "batchSize", "timeFactor", "executor")
}
